...
// -------------------------------------+---------------------------------------+---------------------------------------+---------------------------------------
in_to_mm =25.4;
fasternerDia = 0.25 + 0.01; // Added a bit of play
/* [Assembly Options] */
...
hinge_width                           = 3.25 * in_to_mm; //was 2.5
leaf_height                           = 4 * in_to_mm;
...
fastener_thread_diameter         = in_to_mm * fasternerDia;
...
fastener_margin                  = (.5 - (fasternerDia/2)) * in_to_mm;
